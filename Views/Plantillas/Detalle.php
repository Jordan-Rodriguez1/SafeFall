                      ...
                      <form id="formulario1" method="post" action="<?php echo base_url(); ?>Plantillas/ActualizarPlantilla" autocomplete="off" enctype="multipart/form-data">
                          ...
                          <div class="row">
                              <div class="form-group col-6">
                                ...
                                <input type="tem_max" step="0.01" class="form-control" id="tem_max" name="tem_max" value="<?= $data1['tem_max']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="tem_min">Temperatura Mínima (ºC)</label>
                                <input type="number" step="0.01" class="form-control" id="tem_min" name="tem_min" value="<?= $data1['tem_min']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="humedad_max">Humedad Máxima (%)</label>
                                <input type="number" step="0.01" class="form-control" id="humedad_max" name="humedad_max" value="<?= $data1['humedad_max']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="humedad_min">Humedad Mínima (%)</label>
                                <input type="number" step="0.01" class="form-control" id="humedad_min" name="humedad_min" value="<?= $data1['humedad_min']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="stem_max">Temp. Máxima Suelo (ºC)</label>
                                <input type="number" step="0.01" class="form-control" id="stem_max" name="stem_max" value="<?= $data1['stem_max']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="stem_min">Temp. Mínima Suelo (ºC)</label>
                                <input type="number" step="0.01" class="form-control" id="stem_min" name="stem_min" value="<?= $data1['stem_min']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="shumedad_max">Hum. Máxima Suelo (%)</label>
                                <input type="number" step="0.01" class="form-control" id="shumedad_max" name="shumedad_max" value="<?= $data1['shumedad_max']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="shumedad_min">Hum. Mínima Suelo (%)</label>
                                <input type="number" step="0.01" class="form-control" id="shumedad_min" name="shumedad_min" value="<?= $data1['shumedad_min']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="luz">Horas de luz</label>
                                <input type="number" step="0.01" class="form-control" id="luz" name="luz" value="<?= $data1['luz']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="co2">CO<sub>2</sub> Máximo (ppm)</label>
                                <input type="number" step="0.01" class="form-control" id="co2" name="co2" value="<?= $data1['co2_max']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="altura">Altura de Transplante (cm)</label>
                                <input type="number" step="0.01" class="form-control" id="altura" name="altura" value="<?= $data1['altura']; ?>" required>
                              </div>
                              <div class="form-group col-6">
                                <label for="dias">Días de Transplante</label>
                                <input type="number" class="form-control" id="dias" name="dias" value="<?= $data1['dias']; ?>" required>
                              </div>
                          </div>
                          <button type="submit" class="btn btn-success btn-icon-split">
                              <span class="icon text-white-50">
